                ...
                <div className="flex flex-col w-full">
...

                    {
                        isImage && (
                            ...
                            >
                                <Image className="object-cover" fill alt={content} src={fileUrl} />
                            </a>
                        )
                    }
                    {
                    ...
                    }
                    {
                        !fileUrl && isEditing && (
                            <Form {...form}>
                                <form className="flex items-center w-full gap-x-2 pt-2" onSubmit={form.handleSubmit(submitHandler)}>
                                    <FormField 
